          ...
          <?php echo $this->session->flashdata('message');?>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><strong>Detail Produk</strong></h3><br><br>
    ...
    <!-- <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <div class="card-header">
                <h3 class="card-title">Data Barang Ruangan</h3>
                  <div class="float-sm-right">
                  
                  </div>
              </div> 
              <div class="card-body table-responsive">
              <table border="2" id="example3" class="table table-striped table-bordered text-nowrap" style="width:100%">
                <thead class="table-header">
                    <tr>
                        <th>No</th>
                        <th>Nama Produk</th>
